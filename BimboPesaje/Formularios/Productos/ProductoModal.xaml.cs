...
namespace BimboPesaje.Formularios.Productos
{
    public partial class ProductoModal : System.Windows.Controls.UserControl
    {
        ...
        private async void OnLoaded(object sender, RoutedEventArgs e)
        {
            ...
            try
            {
                var uri = new Uri("pack://application:,,,/BimboPesaje;component/Resources/bimbo_no_bg.png");
                ModalLogo.Source = new BitmapImage(uri);
            }
            catch { }

            // Load fabricantes: load from products list via join (Fabricante doesn't extend BaseModel)
            try
            {
                var prods = await CapaDatos.Repositorios.productos_movimientos.RepositorioProducto.obtenerProductosJoin();
            ...
            try
            {
                var cats = await CapaDatos.Repositorios.productos_movimientos.RepositorioCategoria.ObtenerCategorias();
        ...
        private async void BtnGuardar_Click(object sender, RoutedEventArgs e)
        {
            ...
            {
                System.Windows.MessageBox.Show("C\u00F3digo y nombre son obligatorios.", "Validaci\u00F3n", System.Windows.MessageBoxButton.OK, System.Windows.MessageBoxImage.Warning);
                return;
            }
